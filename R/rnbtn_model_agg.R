...
#' 
#' This function aggregrates model results from rnbtn_model_pergene function for all genes in a serial fashion
#' 
...
rnbtn_model_agg <- function(df,formula,locus_tag=locus_tag,fctrel=NONE,iter=5,a=0){ 
...
locusresults[[g]] <- suppressWarnings(suppressMessages(rnbtn_model_pergene(df_g,formula,res_name,locus_tag="g",iter=5,a=0)))
# garbage collector
   gc()
